// File: @/components/Forms/systemDesignForms/SystemDesignCategory.tsx
...
export const AddCategoryForm = ({ insertIndex }) => {
  ...
  const { addSystemDesignCategory } = useAppStore();
  ...
  const handleAdd = () => {
    ...
    addSystemDesignCategory(newCategory, insertIndex);
...
export const DeleteCategorySheet = () => {
  ...
  const handleDelete = useCallback(() => {
    Array.from(selectedIds).forEach(deleteSystemDesignCategory);
    hideBottomSheet();
    showToast({ message: "Categories deleted", type: "success" });
  }, [selectedIds, deleteSystemDesignCategory]);

...
export const dummyDsaProblems: Problem[] = [
  {
    id: "74f89f78",
    topicId: "9f3fceda", // Belongs to Two Pointers
    title: "Two Sum",
    ...
    solution: "We can use more methods like Binary Search and Hashing to solve this problem (Please refer Two Sum article for details) in better time complexity but Two Pointer Technique is the best solution for this problem that works well for sorted arrays.",
    ...
    similarProblems: [
      {
        ...
        shortExplanation: ["Sort the input array.", "Iterate and fix one element.", "Use a two-pointer approach on the remaining part to find the other two elements.", "Handle duplicates carefully."],
  ...
  },
  {
    ...
    testCase: "Input: height = [1,8,6,2,5,4,8,3,7]\nOutput: 49\nExplanation: The above vertical lines are represented by array [1,8,6,2,5,4,8,3,7]. In this case, the max area of water (blue section) the container can contain is 49.",
    difficultyLevel: "medium",
    ...
    while left < right:
        ...
        if height[left] < height[right]:
            ...
            right -= 1
    return max_water`,
    solution: "The area of water a container can hold is determined by the shorter of the two lines multiplied by the distance between them. A two-pointer approach efficiently explores possible pairs of lines.",
    similarProblems: [],
  },
  {
    id: "c3d26cb6",
    topicId: "8b8a7f34", // Belongs to Sliding Window
    ...
    testCase: 'Input: s = "abcabcbb"\nOutput: 3\nExplanation: The answer is "abc", with the length of 3.',
    difficultyLevel: "medium",
    solution: "Use a hash map to store the last index of each character. Expand the right pointer, and if a duplicate is found, update the left pointer to the next index of the duplicate character.",
